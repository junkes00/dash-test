...
export function SiteHeader() {
  const authenticationUrl = "https://auth.mercadolivre.com.br/authorization?response_type=code&client_id=4933724664056622&redirect_uri=http://apiteste-j2za.onrender.com/callback"
